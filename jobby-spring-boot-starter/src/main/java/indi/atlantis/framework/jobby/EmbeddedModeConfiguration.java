...
import indi.atlantis.framework.jobby.cluster.ConsumerModeJobExecutor;
...
public class EmbeddedModeConfiguration {
	...
	@Configuration
	@ConditionalOnProperty(name = "atlantis.framework.jobhub.scheduler.engine", havingValue = "spring")
	...
	@Configuration
	@ConditionalOnProperty(name = "atlantis.framework.jobhub.scheduler.engine", havingValue = "cron4j", matchIfMissing = true)
