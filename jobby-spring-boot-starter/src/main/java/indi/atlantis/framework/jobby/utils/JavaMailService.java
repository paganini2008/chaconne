package indi.atlantis.framework.jobby.utils;
...
public class JavaMailService {
	...
	@Value("${atlantis.framework.jobhub.mail.username}")
	private String defaultMailSender;

	@Value("${atlantis.framework.jobhub.mail.default.subject:Jobhub Email Warning}")
	private String defaultMailSubject;

	@Value("${atlantis.framework.jobhub.mail.default.recipients:}")
