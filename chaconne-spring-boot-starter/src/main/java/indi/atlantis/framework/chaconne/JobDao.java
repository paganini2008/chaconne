...
public interface JobDao {
	...
	public static final String DEF_INSERT_JOB_TRACE = "insert into chac_job_trace(trace_id,cluster_name,job_id,running_state,address,instance_id,completed,failed,skipped,finished,retries,execution_time,completion_time) values (:traceId,:clusterName,:jobId,:runningState,:address,:instanceId,:completed,:failed,:skipped,:finished,:retries,:executionTime,:completionTime)";
