...
public abstract class DdlScripts {
	...
	public static abstract class CreateScripts {
		...
		static final String DEF_DDL_JOB_TRACE = "create table chac_job_trace(trace_id bigint primary key, cluster_name varchar(45), job_id int not null, running_state int, address varchar(255), instance_id varchar(255), completed int, failed int, skipped int, finished int, retries int, execution_time timestamp, completion_time timestamp)";
